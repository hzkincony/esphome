...
namespace esphome {
  namespace kincony_kc868_ha {

    class KinconyKc868HaBinarySensor : public Component, public binary_sensor::BinarySensor {
    public:
    ...
    class KinconyKc868HaSwitch : public Component, public switch_::Switch {
    public:
      ...
      void dump_config() override;
      void set_switches(std::vector<kincony_kc868_ha::KinconyKc868HaSwitch *>* switches_)  { this->switches_ = switches_; };
    ...
    protected:
      ...
      uint8_t switch_adapter_addr_;
      uint8_t bind_output_;
      std::vector<kincony_kc868_ha::KinconyKc868HaSwitch *>* switches_;
    };

    class KinconyKc868Ha : public Component, public uart::UARTDevice {
    public:
      ...
      void set_switch_adapter_addr(uint8_t addr) { this->switch_adapter_addr_=addr; };
      uint8_t get_switch_adapter_addr() { return this->switch_adapter_addr_; };
      void register_binary_sensor(kincony_kc868_ha::KinconyKc868HaBinarySensor *obj)  { this->binary_sensors_.push_back(obj); };
      void register_switch(kincony_kc868_ha::KinconyKc868HaSwitch *obj)  {
    ...
    protected:
      ...
      uint8_t target_relay_controller_addr_;
      uint8_t switch_adapter_addr_;
      std::vector<kincony_kc868_ha::KinconyKc868HaBinarySensor *> binary_sensors_;
      std::vector<kincony_kc868_ha::KinconyKc868HaSwitch *> switches_;
    };
